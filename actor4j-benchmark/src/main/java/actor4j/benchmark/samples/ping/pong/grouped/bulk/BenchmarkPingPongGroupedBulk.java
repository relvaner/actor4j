...
public class BenchmarkPingPongGroupedBulk extends BenchmarkSample {
	public BenchmarkPingPongGroupedBulk(BenchmarkConfig benchmarkConfig) {
		super();
		
		XActorSystemConfig config = XActorSystemConfig.builder()
			.name("actor4j::PingPong-Grouped-Bulk")
			.sleepMode()
			.build();
