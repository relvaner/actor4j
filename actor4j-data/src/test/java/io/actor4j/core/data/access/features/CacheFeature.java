...
public class CacheFeature {
	...
	public void test_cache_lru_with_gc__get_put_resize() {
		AsyncCacheVolatileLRU<String, String> cache = new AsyncCacheVolatileLRU<>(5);
		...
		for (int i=0; i<data.length-2; i++)
			assertEquals(data[i][1], cache.get(data[i][0], ()->{}, ()->{}, ()->{}).get());
	...
	public void test_cache_lru__get_put_resize() {
		AsyncCacheLRU<String, String> cache = new AsyncCacheLRU<>(5);
