...
public final class ActorGrpcServiceGrpc {
  ...
  public static final io.grpc.MethodDescriptor<io.actor4j.web.grpc.ActorGrpcServiceOuterClass.ActorGRPCRequest,
      io.actor4j.web.grpc.ActorGrpcServiceOuterClass.ActorGRPCResponse> METHOD_SEND = getSendMethodHelper();

  private static volatile io.grpc.MethodDescriptor<io.actor4j.web.grpc.ActorGrpcServiceOuterClass.ActorGRPCRequest,
      io.actor4j.web.grpc.ActorGrpcServiceOuterClass.ActorGRPCResponse> getSendMethod;

  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static io.grpc.MethodDescriptor<io.actor4j.web.grpc.ActorGrpcServiceOuterClass.ActorGRPCRequest,
      io.actor4j.web.grpc.ActorGrpcServiceOuterClass.ActorGRPCResponse> getSendMethod() {
    return getSendMethodHelper();
  }

  private static io.grpc.MethodDescriptor<io.actor4j.web.grpc.ActorGrpcServiceOuterClass.ActorGRPCRequest,
      io.actor4j.web.grpc.ActorGrpcServiceOuterClass.ActorGRPCResponse> getSendMethodHelper() {
    io.grpc.MethodDescriptor<io.actor4j.web.grpc.ActorGrpcServiceOuterClass.ActorGRPCRequest, io.actor4j.web.grpc.ActorGrpcServiceOuterClass.ActorGRPCResponse> getSendMethod;
      ...
      synchronized (ActorGrpcServiceGrpc.class) {
        if ((getSendMethod = ActorGrpcServiceGrpc.getSendMethod) == null) {
          ActorGrpcServiceGrpc.getSendMethod = getSendMethod = 
              io.grpc.MethodDescriptor.<io.actor4j.web.grpc.ActorGrpcServiceOuterClass.ActorGRPCRequest, io.actor4j.web.grpc.ActorGrpcServiceOuterClass.ActorGRPCResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "actor4j.web.grpc.ActorGRPCService", "send"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.actor4j.web.grpc.ActorGrpcServiceOuterClass.ActorGRPCRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.actor4j.web.grpc.ActorGrpcServiceOuterClass.ActorGRPCResponse.getDefaultInstance()))
  ...
  public static abstract class ActorGRPCServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void send(io.actor4j.web.grpc.ActorGrpcServiceOuterClass.ActorGRPCRequest request,
        io.grpc.stub.StreamObserver<io.actor4j.web.grpc.ActorGrpcServiceOuterClass.ActorGRPCResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                io.actor4j.web.grpc.ActorGrpcServiceOuterClass.ActorGRPCRequest,
                io.actor4j.web.grpc.ActorGrpcServiceOuterClass.ActorGRPCResponse>(
                  this, METHODID_SEND)))
          .build();
    }
  }
  ...
  public static final class ActorGRPCServiceBlockingStub extends io.grpc.stub.AbstractStub<ActorGRPCServiceBlockingStub> {
    ...
    /**
     */
    public io.actor4j.web.grpc.ActorGrpcServiceOuterClass.ActorGRPCResponse send(io.actor4j.web.grpc.ActorGrpcServiceOuterClass.ActorGRPCRequest request) {
  ...
  public static final class ActorGRPCServiceFutureStub extends io.grpc.stub.AbstractStub<ActorGRPCServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<io.actor4j.web.grpc.ActorGrpcServiceOuterClass.ActorGRPCResponse> send(
        io.actor4j.web.grpc.ActorGrpcServiceOuterClass.ActorGRPCRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SEND:
          serviceImpl.send((io.actor4j.web.grpc.ActorGrpcServiceOuterClass.ActorGRPCRequest) request,
              (io.grpc.stub.StreamObserver<io.actor4j.web.grpc.ActorGrpcServiceOuterClass.ActorGRPCResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class ActorGRPCServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return io.actor4j.web.grpc.ActorGrpcServiceOuterClass.getDescriptor();
    }
