...
public class ExamplePolyglotFunctionPod_JS4 extends PolyglotFunctionPod {
	@Override
	public String domain() {
		return "ExamplePolyglotFunctionPod_JS4";
	}
	...
	public CharSequence script() {
		return """
			function execute(api, message) {
				...
				api.send({value: "Hello Test3!", tag: 99}, 99, null, message.source());
